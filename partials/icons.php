...
if (!function_exists('asset_ver')) {
    /**
     * Suffixe de version pour un fichier (CSS/JS), basé sur sa date de
     * modification : « ?v=1718000000 ». Force le navigateur à recharger le
     * fichier dès qu'il change, malgré la mise en cache du .htaccess.
     */
    function asset_ver(string $chemin): string {
        return is_file($chemin) ? '?v=' . filemtime($chemin) : '';
    }
}

if (!function_exists('date_fr')) {
    /**
     * Convertit une date "AAAA-MM-JJ" en date lisible en français : "3 juin 2026".
     * Renvoie la chaîne d'origine si elle n'est pas une date valide.
     */
